...
|------------------|------------|----------|
| `i`             | Нормальный | Перейти в режим вставки |
| `a`             | Нормальный | Вставить после курсора |
| `I`             | Нормальный | Вставить в начало строки |
| `A`             | Нормальный | Вставить в конец строки |
| `o`             | Нормальный | Новая строка ниже |
| `O`             | Нормальный | Новая строка выше |
| `r`             | Нормальный | Заменить символ |
| `R`             | Нормальный | Режим замены |
| `x`             | Нормальный | Удалить символ |
| `dd`            | Нормальный | Удалить строку |
| `yy`            | Нормальный | Копировать строку |
| `p`             | Нормальный | Вставить после |
| `P`             | Нормальный | Вставить до |
| `u`             | Нормальный | Отменить |
| `<C-r>`        | Нормальный | Повторить |
| `h,j,k,l`       | Нормальный | Движение курсора |
| `w`             | Нормальный | На слово вперед |
| `b`             | Нормальный | На слово назад |
| `0`             | Нормальный | В начало строки |
| `^`             | Нормальный | К первому символу строки |
| `$`             | Нормальный | В конец строки |
| `gg`            | Нормальный | В начало файла |
| `G`             | Нормальный | В конец файла |
| `<C-d>`        | Нормальный | Прокрутка вниз |
| `<C-u>`        | Нормальный | Прокрутка вверх |
| `:split`        | Нормальный | Горизонтальное разделение |
| `:vsplit`       | Нормальный | Вертикальное разделение |
| `<C-w>h/j/k/l` | Нормальный | Переключение окон |
| `gt`            | Нормальный | Следующая вкладка |
| `gT`            | Нормальный | Предыдущая вкладка |
| `:bn`           | Нормальный | Следующий буфер |
| `:bp`           | Нормальный | Предыдущий буфер |
| `:bd`           | Нормальный | Закрыть буфер |
| `<C-^>` (`Ctrl-6`) | Нормальный | Переключение на ранее открытый буфер |
| `/текст`        | Нормальный | Поиск вперед |
| `?текст`        | Нормальный | Поиск назад |
| `n`             | Нормальный | Следующее совпадение |
| `N`             | Нормальный | Предыдущее совпадение |
| `<C-w>`        | Вставка    | Удалить слово |
| `<C-o>`        | Вставка    | Перейдет в нормальный режим для выполнения одной команды |
| `"ayy`          | Нормальный | Копировать в регистр |
| `@a`            | Нормальный | Выполнить макрос |
| `:w`            | Нормальный | Сохранить |
| `:q`            | Нормальный | Выйти |
| `:wq`         | Нормальный | Сохранить и выйти |
| `:x`         | Нормальный | Делает тоже самое, что и `:wq`, но если файл не изменен, запись не происходит |
| `ZZ`            | Нормальный | Сохранить и выйти |
| `ZQ`            | Нормальный | Выйти без сохранения |
| `v`             | Нормальный | Визуальный режим (символьный) |
| `V`             | Нормальный | Визуальный режим (строчный) |
| `<C-v>`        | Нормальный | Визуальный режим (блочный) |
| `y`             | Визуальный | Копировать выделенное |
| `d`             | Визуальный | Удалить выделенное |
| `:%s/old/new/g` | Нормальный | Глобальная замена |
| `:s/old/new/g`  | Нормальный | Замена в текущей строке |
| `*`             | Нормальный | Поиск слова под курсором вперед |
| `#`             | Нормальный | Поиск слова под курсором назад |
| `gf`            | Нормальный | Перейти к файлу под курсором |
| `gx`            | Нормальный | Перейти по ссылк под курсором |
| `K`             | Нормальный | Просмотр man-страницы |
| `:!команда`     | Нормальный | Выполнить shell-команду |
| `:r !команда`   | Нормальный | Вставить вывод команды |
